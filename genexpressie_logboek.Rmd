...
deseq.volcano(res = res.vaper.control, datasetName = "De genen van de groep vaper in vergelijking met controle")
deseq.volcano(res = res.smoker.control, datasetName = "De genen van de groep smoker in vergelijking met controle")
```
...
Uit de analyse op DAVID komt een chart. Deze wordt bovenstaand ingeladen. 
...
# pathview(gene.data=vaper.degs.lfc,
#          pathway.id="00970",
#          species="hsa")
```
