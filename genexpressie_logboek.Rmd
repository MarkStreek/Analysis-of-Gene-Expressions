...
vaper.degs.lfc <- data.frame(ID = DAVID_genes[1,]$Genes, LogFoldChange = vaper.degs.lfc)
vaper.degs.lfc

write.table(vaper.degs.lfc, file = "vaper.degs.lfc.txt", row.names = T, quote = F, col.names = T)
...
barplot(-log10(x) ~ DAVID.vaper.terms.split, las = 2, cex.names = 0.5, horiz = T)
```
